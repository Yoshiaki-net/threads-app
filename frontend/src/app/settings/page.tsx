          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <button
                ...
                className={`w-11 h-6 rounded-full transition-colors relative ${form.notifications_enabled ? 'bg-[#1E3464]' : 'bg-gray-200'}`}
              >
                <span className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${form.notifications_enabled ? 'translate-x-5' : 'translate-x-0.5'}`} />
              </button>
            </div>
